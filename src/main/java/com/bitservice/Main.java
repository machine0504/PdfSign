...
import com.bitservice.configuration.SealCircle;
import com.bitservice.configuration.SealConfiguration;
import com.bitservice.configuration.SealFont;
...
public class Main {
    ...
    public static void ImageSet(String cont,String num) throws Exception {
        /**
         * 印章配置文件
         */
        ...
        /**************************************************/
        mainFont.setFontText(cont);
        mainFont.setFontSize(38);
...
//        configuration.setInnerCircle(new SealCircle(2, 85, 45));
        ...
        font.setFontSize(120).setBold(true).setFontText("张一川");
        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "d:\\私章.png");
    }

    public static void ImageSet2(String cont,String num,String gzFullPath,String szFullPath) throws Exception {
        /**
         * 印章配置文件
         */
        SealConfiguration configuration = new SealConfiguration();
...
//        configuration.setInnerCircle(new SealCircle(2, 85, 45));
        ...
        try {
//            SealUtil.buildAndStoreSeal(configuration, "d:\\公章.png");
            SealUtil.buildAndStoreSeal(configuration, gzFullPath);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        font.setFontSize(120).setBold(true).setFontText("张一川");
//        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "d:\\私章.png");
        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", szFullPath);
    }
