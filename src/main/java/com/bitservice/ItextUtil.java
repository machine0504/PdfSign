...
public class ItextUtil {
        ...
        try {
            ...
            appearance.setVisibleSignature(
                    new Rectangle(signatureInfo.getRectllx(), signatureInfo
                            ...
                            signatureInfo.getRectury()), 2, signatureInfo
                            .getFieldName());
            // 读取图章图片
    ...
    public static void main(String[] args) {
        try {
            //生成公章/私章
            Main.ImageSet("西安必特思维软件有限公司","1234567891234");
            ItextUtil app = new ItextUtil();
            // 将证书文件放入指定路径，并读取keystore ，获得私钥和证书链
            String pkPath = "D:/mdx.p12";
...
//            // 签章图片
//            signInfo.setImagePath("D:/公章.png");
...
//            //签章后的pdf路径
//            app.sign(path, "D:/demo1.pdf", signInfo);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
